...
const Stories = () => {
  return (
    <div className="flex gap-10">
          ...
          <img
              src="https://s2982.pcdn.co/wp-content/uploads/2022/02/rapper-musician-performer-MC-featured.jpg.optimal.jpg"
              className=" rounded-3xl border-solid border-yellow-300 border-2 -mt-3 h-24 w-24 object-cover"
            />
            <h1 className='text-white text-center font-semibold'>Arthur</h1>
          </div>

          <div className="flex-col justify-center space-y-2">
          <img
              src="https://www.rollingstone.com/wp-content/uploads/2022/02/5-Tips-for-Any-Artist-Looking-to-Release-New-Music.png"
              className=" rounded-3xl border-solid border-gray-700 border-2 -mt-3 h-24 w-24 object-cover"
            />
            <h1 className='text-white text-center'>Votaliy</h1>
          </div>
